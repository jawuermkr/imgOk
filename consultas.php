  ...
  <header>
    <div class="px-3 py-2 bg-dark text-white">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        ...
        <small class="text-secondary">Sesión de: <b><?php echo $_SESSION['nombre']; ?></b></small>
      </div>
    </div>
  </header>
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        if (isset($_POST['act'])) {
          ...
          $_UPDATE_SQL = "UPDATE solicitud Set 
                color = '$color',
                estado = '$estado' WHERE id_ask = '$id'";

          echo "Se ha generado la actualización.";
